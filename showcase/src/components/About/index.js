...
const About = () => {
  ...
  if (isLoading) {
    return <Loading message="Loading About..." showTitle={true} title="About Me" subtitle="Getting to know me better" />;
  }
  ...
  return (
    <div className="container about-page about-responsive">
      <div className="about-sidebar">
        ...
        <a className="about-info" href="mailto:vdppatel@ucdavis.edu" ><FontAwesomeIcon icon={faEnvelope} /> Email</a>
